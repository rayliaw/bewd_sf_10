...
| ------- | :---------- | :---------- |
| 209 | [Devise (revised)](https://www.youtube.com/watch?v=tkvXjYRNYmU) | Out of the box implementation of authentication. |
| 250 | [Auth from scratch (revised)](https://www.youtube.com/watch?v=0w5nUz4zVGg) | DIY Authentication from scratch. |
| 353 | [Authentication with OAuth](https://www.youtube.com/watch?v=zN9BylV81rw) | Third party credential verification (Google, Twitter) |
